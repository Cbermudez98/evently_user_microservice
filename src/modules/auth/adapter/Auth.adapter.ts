...
export class AuthAdapter implements IRouterAdapter {
    ...
    constructor() {
        ...
        this._authController = handlerContainer.get<IAuthController>(Types.AUTH_CONTROLLER);
        this._schemaValidator = handlerContainer.get<ISchemaValidator>(Types.SCHEMA_MIDDLEWARE);
    ...
    initRoute(): Router {
        ...
        (req: IRequest, res: Response) => {
            this._routerManager.handler(this._authController.login(req.body), req, res);
        });
