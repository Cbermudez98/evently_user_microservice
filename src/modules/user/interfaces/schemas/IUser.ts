...
export interface IUserCreate extends Omit<IUser, "id" | "created_at" | "updated_at" | "auth"> {
    auth: Pick<IAuth, "email" | "password">
}

export interface IUserUpdate extends Partial<Omit<IUser, "auth" | "created_at" | "updated_at">> {}
