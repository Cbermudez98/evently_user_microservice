...
import { IUserCreate, IUser, IUserUpdate, IUserFilter } from "../interfaces/schemas/IUser";
...
export class UserService implements IUserService {
    ...
    constructor(@inject(Types.AUTH_SERVICE) private readonly _authService: IAuthService) {
