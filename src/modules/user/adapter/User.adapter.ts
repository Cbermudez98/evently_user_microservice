...
export class UserAdapter implements IRouterAdapter {
    ...
    constructor() {
        ...
        this._userController = handlerContainer.get<IUserController>(Types.USER_CONTROLLER);
        this._routerManager = handlerContainer.get<IManagerRouter>(Types.ROUTER_MANAGER);
        this._schemaMiddleware = handlerContainer.get<ISchemaValidator>(Types.SCHEMA_MIDDLEWARE);
    }
    ...
    initRoute(): Router {
        this._userRouter.post("/",
            ...
            this._routerManager.handler(this._userController.createUser(req.body), req, res);
        });
